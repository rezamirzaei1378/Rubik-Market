...
namespace Rubik_Market.Infra.Data.Migrations
{
    ...
    [Migration("20250128202728_CreateUserAddressTable")]
    partial class CreateUserAddressTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Rubik_Market.Domain.Models.AboutUsDescription", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AboutUsText = "Default",
                            CreateDate = new DateTime(2025, 1, 28, 23, 57, 24, 720, DateTimeKind.Local).AddTicks(3049),
                            isDelete = false
                        });
                });
